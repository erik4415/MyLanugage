...
abstract class ASTNode {
	...
	public enum AdrMode{
		 global,local,literal,stack,none
	 }
...
class memberDeclsNode extends ASTNode {
    ...
    memberDeclsNode(fieldDeclsOption f, methodDeclsOption m, memberDeclsNode e,
                    int line, int col){
            super(line,col);
            fields=f;
            methods=m;
...
class printNode extends printNodeOption {
        ...
        public final exprNodeOption       	outputValue;
        public final printNodeOption	morePrints;

        printNode(exprNodeOption val, printNodeOption pn, int line, int col){
                super(line,col);
                outputValue=val;
                morePrints=pn;
        }
...
class nameNode extends exprNode {
		...
		super(line,col,Types.Unknown, Kinds.Array);
		varName=id;
		subscriptVal=expr;
	};
